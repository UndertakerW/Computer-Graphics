...
class SceneLight {
 public:
  ...
  virtual Vector3D sample_L_backward(const Vector3D d, const BVHAccel* bvh,
                             Vector3D* sample, Vector3D* hit_p, double* distToLight, double* pdf, BSDF** bsdf, Vector3D* n) const = 0;
